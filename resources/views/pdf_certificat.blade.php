...
<main>
    <div class="px-4 py-5 my-5 text-center" id="pdf_test" heigth="250">
        ...
        <h3 class="fw-bold">🏅 Félicitation à l'Equipe {{$select[0]->nom_equipe}} 🏅</h3>
        <div class="col-lg-6 mx-auto">
            <p class="lead mb-4">Ce certificat revient à l'<b>Equipe {{$select[0]->nom_equipe}}</b> qui ont réussi pour le classement général.</p>
            <p></p>
            ...
            <div class="row mt-5">
                <div class="col-6 justify-content-start">
                    <h5>Total points: {{$select[0]->totals}} points 🎢.</h5>
                </div>
