...
@section('title', 'Classement_etape_equipe_'.$equipe)
@section('equipe', $equipe)
@section("classement")
<div class="row pt-3">
    <h4>Voir classement pour chaque etape pour l'Equipe {{$equipe}}</h4>
    <div class="card-body">
        <div class="row">
            @foreach ($class as $etape => $class)
                <div class="col-md-3">
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#classement_{{$etape}}">Voir rang</button>
                        </div>
