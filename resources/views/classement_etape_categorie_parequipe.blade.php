...
@section('title', 'Classement_pour_equipe_'.$equipe.'_categorie')
@section('equipe', $equipe)
@section("classement")
<div class="row pt-3">
    <div class="col-12">
        <h4>Voir classement par étape pour chaque categorie pour Equipe {{$equipe}}</h4>
        <div class="card-body">
            <div class="row">
                @foreach ($etapes as $etape => $participants)
                    <div class="col-md-4">
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#etape_categorie_{{$etape}}">Voir rang</button>
                            </div>
